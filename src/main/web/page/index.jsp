...
<head>
    ...
    <link rel="shortcut icon" href="${resources}/themes/default/images/order_up.gif"/>
...
<div id="layout">
    <div id="header">
        <div class="headerNav">
            <a class="logo" href="http://www.baidu.com">标志</a>
            <ul class="nav">
                <li id="switchEnvBox"><a href="javascript:">（<span>上海</span>）切换城市</a>
                    <ul>
                        <li><a href="sidebar_1.html">上海</a></li>
                        <li><a href="sidebar_2.html">苏州</a></li>
                        <li><a href="sidebar_2.html">无锡</a></li>
                        <li><a href="sidebar_2.html">常州</a></li>
                        <li><a href="sidebar_2.html">南京</a></li>
                        <li><a href="sidebar_2.html">嘉兴</a></li>
            ...
            <div class="accordion" fillSpace="sidebar">
                ...
                <div class="accordionContent">
                    <ul class="tree treeFolder">
                        ...
                        <li><a href="../web-resources/dwz/dwz.frag.xml" target="navTab" external="true">dwz.frag.xml</a></li>
                    </ul>
                </div>
                <div class="accordionHeader">
...
邮箱：avonny@126.com
                    ...
                    <div style="width:230px;position: absolute;top:60px;right:0" layoutH="80">
                        <iframe width="100%" height="430" class="share_self"  frameborder="0" scrolling="no" src="http://ww.baidu.com"></iframe>
                    </div>
                </div>
...
<div id="footer">Copyright Cubic&copy; 2010 <a href="demo_page2.html" target="dialog">Cubic团队</a> 沪ICP备0000000001号</div>
